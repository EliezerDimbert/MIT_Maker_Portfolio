...
void playNextDirection() {
  ...
  Serial.println("Sending " + String(cacPlaySound(myNextDirection)) + " thru playSound with direction " + String(facingDirection));
  playSound(cacPlaySound(myNextDirection));  //Goto Audio_Funcs
}
